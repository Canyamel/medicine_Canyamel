...
import { Flex, Form, Input, Space, Descriptions, Badge, ConfigProvider, Select, Tag, Col, Row, Button, Tooltip  } from 'antd';
...
const specialistOptions: Specialist[] = [
    ...
    { id: 4, lastName: 'Иванов', firstName: 'Сергей', fatherName: 'Иванович', medOrganisation: 'Больница №1' },
...
export default function SendCard() {
    ...
    const options = filteredOptions.map((specialist) => ({
        ...
        optionFilter: specialist.lastName + ' ' + specialist.firstName + ' ' + specialist.fatherName + ' ' + specialist.medOrganisation
    }));
    ...
    const tagRender = (props: any) => {
        return (
            <Tooltip title={formatTooltip(props.value)}>
                <Tag style={{ height: '30px', lineHeight: '28px' }} closable>
                    {formatTag(props.value)}
                </Tag>
            </Tooltip>
            );
    ...
    return(
        <ConfigProvider theme={{
            ...
            <Row className="page" justify='space-evenly'>
                <Col span={8} >
                ...
                <Col span={14}>
                    ...
                    >
                        ...
                        <Item name='specialist' label='Специалисты'>
                            <Select
                                size='large'
                                mode='multiple'
                                options={options}
